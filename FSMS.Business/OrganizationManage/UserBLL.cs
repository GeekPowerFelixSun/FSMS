...
namespace FSMS.Business.OrganizationManage
{
    /// <summary>
    /// ImportParam
    /// </summary>
    public class UserBLL
    {
        ...
        private UserBelongService userBelongService = new UserBelongService();  //用哪一个service
        private DepartmentService departmentService = new DepartmentService();  //属于哪个部门

        private LogLoginBLL logLoginBLL = new LogLoginBLL();    //login业务逻辑
